...
public class SignalRTestClient : ITransferFormatFeature, IConnectionHeartbeatFeature, IDisposable
{
    ...
    public SignalRTestClient(bool synchronousCallbacks = false, IHubProtocol? protocol = null,
